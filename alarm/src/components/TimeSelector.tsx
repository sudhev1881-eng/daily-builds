...
function Wheel({
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      <div
        className="clock-font w-24 cursor-ns-resize select-none rounded-2xl border border-white/10 bg-black/40 py-5 text-center text-5xl font-bold shadow-[inset_0_0_24px_rgba(255,59,107,0.12)] sm:w-28 sm:text-6xl"
        onPointerDown={(e) => {
          if (disabled) return;
        ...
        onPointerMove={(e) => {
          ...
          onChange((start.current.v + steps + max * 8) % max);
        }}
        onPointerUp={() => {
          start.current = null;
        }}
